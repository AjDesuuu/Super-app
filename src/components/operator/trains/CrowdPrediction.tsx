...
const getLevelColor = (level: string) => {
  switch (level) {
    ...
    case "high":
      return { color: "#f97316", bg: "bg-orange-500/10", text: "text-orange-600 dark:text-orange-400", border: "border-orange-500/30" };
    case "moderate":
      return { color: "#eab308", bg: "bg-yellow-500/10", text: "text-yellow-600 dark:text-yellow-400", border: "border-yellow-500/30" };
    case "low":
      return { color: "#22c55e", bg: "bg-green-500/10", text: "text-green-600 dark:text-green-400", border: "border-green-500/30" };
    default:
