...
export default function RailOperatorDashboard({
  onBack,
  onLogout,
}: RailOperatorDashboardProps) {
    ...
    <div className="h-[95vh] w-[430px] bg-background flex flex-col overflow-hidden">
      ...
      <header className="border-b bg-card flex-shrink-0">
        <div className="px-4 py-3 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-[#E9406B]">
              NexPath Rail Ops
            </h1>
            ...
            return (
              <Button
                ...
                className={cn(
                  ...
                  isActive &&
                    "bg-emerald-600/10 text-emerald-600 hover:bg-emerald-600/20 hover:text-emerald-600",
                )}
              >
