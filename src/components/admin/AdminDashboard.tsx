...
export default function AdminDashboard({ onLogout }: AdminDashboardProps) {
  ...
  const [adZones, setAdZones] = useState<AdZone[]>([
    {
      id: "z1",
      name: "Quezon City Jeepney Stops",
      area: "QC",
      enabled: true,
      impressions: 15420,
      revenue: 77100,
      ...
      clients.map((client) =>
        client.id === clientId
          ? {
              ...
              features: {
                ...client.features,
                [feature]: !client.features[feature],
              },
            }
          : client,
      ),
  ...
  const totalSubscriptionRevenue = clients.reduce(
          ...
          <div className="p-4 space-y-4 ">
            ...
            <div className="space-y-3">
              ...
              <Card className="bg-emerald-500/10">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    ₱{(totalAdRevenue / 1000).toFixed(0)}K
                  </div>
                  <p className="text-xs text-muted-foreground">
              ...
              <Card className="bg-amber-500/10">
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    ₱{(totalSubscriptionRevenue / 1000000).toFixed(1)}M
                  </div>
                  <p className="text-xs text-muted-foreground">
                  ...
                  <form onSubmit={addAdZone} className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        id="name"
                        name="name"
                        placeholder="e.g., Manila CBD Stops"
                        required
                      />
                    </div>
                    <div className="space-y-2">
                  ...
                  {zone.enabled && (
                    <div className="flex items-center justify-between text-xs pt-2 border-t">
                      <span className="text-muted-foreground">
                        {zone.impressions.toLocaleString()} views
                      </span>
              ...
              <Card key={client.id}>
                <CardContent className="p-3 space-y-3">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <Button
                      onClick={() =>
                        toggleFeature(client.id, "crowdPrediction")
                      }
                      variant={
                        client.features.crowdPrediction ? "default" : "outline"
                      }
                      size="sm"
                      className={cn(
                        "text-xs h-8",
                        client.features.crowdPrediction
                    ...
                    <Button
                      onClick={() =>
                        toggleFeature(client.id, "incidentAnalysis")
                      }
                      variant={
                        client.features.incidentAnalysis ? "default" : "outline"
                      }
                      size="sm"
                      className={cn(
                        "text-xs h-8",
                        client.features.incidentAnalysis
                          ? "bg-red-600 hover:bg-red-700"
                          : "",
                      )}
                    >
                    ...
                    <Button
                      onClick={() =>
                        toggleFeature(client.id, "historicalReports")
                      }
                      variant={
                        client.features.historicalReports
                          ? "default"
                          : "outline"
                      }
                      size="sm"
                    ...
                    <Button
                      ...
                      variant={
                        client.features.apiAccess ? "default" : "outline"
                      }
                      size="sm"
                      className={cn(
                        "text-xs h-8",
                        client.features.apiAccess
                          ? "bg-red-600 hover:bg-red-700"
                          : "",
                      )}
                    >
              ...
              <CardContent className="p-3 space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    onChange={(e) =>
                      setCrowdAlertThreshold(Number(e.target.value))
                    }
                    className="w-full h-2 bg-gray-200 rounded-lg appearance-none cursor-pointer accent-red-600"
                  />
                </div>
    ...
    <div className="h-[95vh] w-[430px] bg-background flex flex-col overflow-hidden">
      ...
      <header className="border-b bg-card flex-shrink-0">
        <div className="px-4 py-3 flex items-center justify-between">
          <div>
            <h1 className="text-xl font-bold text-[#E9406B]">NexPath Admin</h1>
            <p className="text-xs text-muted-foreground">
